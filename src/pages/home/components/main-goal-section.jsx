      ...
      <div className="grid items-center gap-8 rounded-3xl bg-muted p-8 lg:grid-cols-2 lg:p-12">
        <div className="flex flex-col gap-6">
          ...
          <p className="max-w-md text-sm text-muted-foreground">
            ...
            services, conditions treated, and treatment options. This ensures
        ...
        <div className="flex items-end justify-center">
          <div
            aria-hidden="true"
            className="flex aspect-square w-full overflow-hidden max-w-sm items-center justify-center rounded-3xl bg-linear-to-br from-violet-200 to-violet-100"
          >
